...
export default {
  ...
  acknowledgeAlert: (id: string) => `${metricsPrefix}/alerts/${id}/ack`,
  ...
  registryMissingAlertRules: `${metricsPrefix}/registry-missing-alert-rules`,
  updateRegistryMissingAlertRule: (id: string) => `${metricsPrefix}/registry-missing-alert-rules/${id}`,
  deleteRegistryMissingAlertRule: (id: string) => `${metricsPrefix}/registry-missing-alert-rules/${id}/delete`,
