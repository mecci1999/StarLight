...
export const TYPE_ICONS: Record<string, string> = Object.fromEntries(QUESTION_TYPES.map((t) => [t.value, t.icon]))

/** Map from type value to Tailwind color classes. */
export const TYPE_COLORS: Record<string, string> = Object.fromEntries(QUESTION_TYPES.map((t) => [t.value, t.color]))
 ...
 */
export function createDragHandlers(onReorder: (fromIndex: number, toIndex: number) => void): DragHandlers {
