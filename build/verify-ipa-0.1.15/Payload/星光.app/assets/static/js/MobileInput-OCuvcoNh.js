...
import { p as e, a1 as t, w as l, aK as a } from './invariable-DewVS0br.js'
const o = e({
  name: 'MobileInput',
  props: {
  ...
  setup(e, { emit: o }) {
    const r = t(() => ['mobile-input', e.error && 'mobile-input--error']),
      n = (e) => {
      ...
      l('div', { class: r.value }, [
        l(
          ...
          },
          {
            ...
            button: 'function' == typeof e.rightIcon ? () => e.rightIcon() : void 0
          }
        ),
        e.errorMessage && l('div', { class: 'mobile-input__error-message' }, [e.errorMessage])
      ])
  }
})
export { o as M }
