...
describe('getPlatformPackageCandidates', () => {
  test('returns x64 and baseline candidates for Linux glibc', () => {
    ...
    expect(result).toEqual(['oh-my-opencode-linux-x64', 'oh-my-opencode-linux-x64-baseline'])
  })
  ...
  test('returns x64 musl and baseline candidates for Linux musl', () => {
    ...
    expect(result).toEqual(['oh-my-opencode-linux-x64-musl', 'oh-my-opencode-linux-x64-musl-baseline'])
  })
  ...
  test('returns baseline first when preferBaseline is true', () => {
    ...
    expect(result).toEqual(['oh-my-opencode-windows-x64-baseline', 'oh-my-opencode-windows-x64'])
  })
